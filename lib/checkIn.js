			...
			node.get(
				...
				function(value){
					if (value != null){
						...
						log(group.friendList[f].name+" ("+group.name+") is at :\n"+pos.coords.latitude+", "+pos.coords.longitude);
						showPosition(pos.coords);//TODO:map markers or link on the log()
					}else{
						log("Could not find location of "+group.friendList[f].name+" ("+group.name+").");
					}
				}
			);
		}
