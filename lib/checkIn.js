var checkIn = {
	putMyLocation : function(arg){
		...
		if(navigator.geolocation) {
			...
			}, showGeoError, {enableHighAccuracy:true}
			);
		}
			...
			node.get(
				...
				function(value){
					if (value != null){
						...
						if (pos != null){
							log(""+friend.name+" ("+group.name+") is at :\n<a href='http://maps.google.com/maps?z=18&q="+pos.coords.latitude+","+pos.coords.longitude+"' target='_blank'>"+pos.coords.latitude+", "+pos.coords.longitude+"</a>");
