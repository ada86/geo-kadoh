			...
			node.get(
				...
				function(value){
					if (value != null){
						...
						if (pos != null){
							friend.lastPos = pos;
							log(""+friend.name+" ("+group.name+") is at :\n<a href='http://maps.google.com/maps?z=18&q="+pos.coords.latitude+","+pos.coords.longitude+"' target='_blank'>"+pos.coords.latitude.toString().substring(0,6)+", "+pos.coords.longitude.toString().substring(0,6)+"</a> ("+d.toUTCString()+")");
