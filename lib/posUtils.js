...
function showPosition(coords,add){
	...
	if (add == true) {
		if (globalMap == null || globalMapMobile == null) {
			...
			globalMap=map;
			setMarker(map,latlon,'http://maps.google.com/mapfiles/ms/icons/red-dot.png');
			var mapholderMobile=document.getElementById('mapholderMobile');
			mapholder.style.height='150px';
			var map=new google.maps.Map(mapholderMobile,myOptions);
			globalMapMobile=map;
			setMarker(map,latlon,'http://maps.google.com/mapfiles/ms/icons/red-dot.png');
		}else{
			setMarker(globalMap,latlon,'http://maps.google.com/mapfiles/ms/icons/blue-dot.png');
			setMarker(globalMapMobile,latlon,'http://maps.google.com/mapfiles/ms/icons/blue-dot.png');
		...
		setMarker(map,latlon,'http://maps.google.com/mapfiles/ms/icons/red-dot.png');
		setMarker(mapMobile,latlon,'http://maps.google.com/mapfiles/ms/icons/red-dot.png');
	}
}

function setMarker(map,pos,icon){
