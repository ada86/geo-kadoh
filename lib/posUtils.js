var posUtils = {
	...
	handleFriendLocation : function(value, friend){
		if (value != null){
			...
			if (position != null){
				log(position.username + " is at : <a href='http://maps.google.com/maps?z=18&q="+position.coords.latitude+","+position.coords.longitude+"' target='_blank'>"+position.coords.latitude+", "+position.coords.longitude+"</a>");
