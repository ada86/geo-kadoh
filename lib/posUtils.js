	...
	handleFriendLocation : function(value, friend){
		if (value != null){
			...
			if (position != null){
				...
				log(position.username + " is at :\n<a href='http://maps.google.com/maps?z=18&q="+position.coords.latitude+","+position.coords.longitude+"' target='_blank'>"+position.coords.latitude.toString().substring(0,6)+", "+position.coords.longitude.toString().substring(0,6)+"</a>\n("+d.toUTCString()+")");
