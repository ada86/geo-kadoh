var htmlEvents = {
	...
	loggedIn : function(){
			...
			document.getElementById('hero1').innerHTML='<h3>Geo-KadOH</h3>';
			document.getElementById('logo').innerHTML='<img height="133" width="135"src="bootstrap/img/Geo-KadOH_logo.png">';
