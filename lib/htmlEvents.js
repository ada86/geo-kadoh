var htmlEvents = {
	...
	loggedIn : function(){
		...
		document.getElementById('loggedInMobile').innerHTML='Logged in as '+config.name+'<button class=\'btn btn-success\' onClick=\'log("Your key is : '+config.pubkey+' ")\'> Show my key </button>';
