var configManager = {
	...
	*/
	logIn : function(){
		...
		var tmpConf;
		config = undefined;
		// TODO: either update config from dht after recovery 
		// from local OR check if config is on dht first and then 
		// recover it from local if not found... the second one
		// is better...
		...
		else {console.log("did not log in.");}
	},
