	...
	*/
	logIn : function(){
		...
		try{//Check if user is in LocalStorage
			...
			document.getElementById('info').innerHTML="<li><button class="btn btn-success" onClick="log("Your key is:"+config.pubkey)"> Show info</button></li>"
	...
	addFriendList : function(name, key){
		if ( (typeof config == "undefined") || !config.friendList || name == null || name == "") return 1;
